/* =============================================================================
   VTYS-1 DÖNEM PROJESİ - KOMPLE SQL DOSYASI
   Çevrimiçi Yemek Sipariş Platformu + Askıda Yemek Modülü
   DBMS: Microsoft SQL Server (T-SQL)
   
   Bu dosya 6 ayrı bölüm dosyasının birleşimidir.
   Çalıştırma sırası:
     1) 01_Veritabani_Olustur.sql   - DDL (tablolar, kısıtlar)
     2) 02_Indexler.sql             - performans için indexler
     3) 04_Gorunumler.sql           - View'lar
     4) 03_Tetikleyiciler.sql       - Trigger'lar (veri eklenmeden ÖNCE)
     5) 05_TestVerileri.sql         - Sahte veriler + trigger demoları
     6) 06_AnalitikSorgular.sql     - JOIN/GROUP/HAVING/subquery örnekleri
   ============================================================================= */
